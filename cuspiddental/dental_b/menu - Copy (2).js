...
$(' #cadcam_tabs4, #appointment_divr2, #append_invoice, .pt_contact_shower,#pt_contact_shower, #cadcam_tabs, #cadcam_tabs3, #ins_price_ed, .dialog_with_tab ,.div_shower44,  #appointment_div2,  #edit_waiting_list, .procedure_container2').on('submit', '.patient_form', function(e){
//alert('oo1');
//	else{alert ('nnnnnnnnnnnnnnnnnnnnnn');}
	var action = $(this).attr("action");
	var element = $(this);
