		...
		<!-- patient complaint -->
			...
			while($i <= 1){ ?>
				<div class='grid-100  remove-inside-padding'>
						...
						<div class='grid-100 highlight_on_hover'><textarea   rows="" name="complaint[]"><?php echo $_SESSION ['complaint']; ?></textarea></div>	
				</div>			
			<?php 
				$i++;	
			} ?>
		...
		<!-- diagnosis -->
			...
			while($i <= 1){ ?>
				<div class='grid-100  remove-inside-padding'>
						...
						<div class='grid-100 highlight_on_hover'><textarea   rows="" name="diagnosis[]"><?php echo $_SESSION['diagnosis']; ?></textarea></div>	
				</div>			
			<?php 
				$i++;	
			} ?>
			...
			while($i <= 5){ 
				...
				echo "<div class='grid-100 tplan_procedures highlight_on_hover1 '>";//was hover before
					...
					echo "<div class='grid-45 grid-parent'>";
						...
						$sql2="select name,id,all_teeth from procedures where id!=2 and id!=8 and id!=59 and listed=0 order by name";
