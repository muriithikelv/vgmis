...
$_SESSION['last_xray']= $_SESSION['done1']= $_SESSION['appearance']=  $_SESSION['when_added']='';
}
...
function get_patient_dental($pdo,$criteria,$patient_number) {// include 'db.inc.php';
	...
	b.prev_ye_no, b.prev, b.curr, b.last_dental, b.last_xray, b.done1, b.appearance, b.when_added, from 
...
$sql=$error=$s='';$placeholders=array();
	...
	else{return "good###<label class=label>This patient has no invoices</label>###no_invoices";}
...
function send_email($mail , $to_email_address ,$to_email_name, $subject, $body, $pid){
	...
	$mail->SMTPSecure = $_SESSION['smtp_secure'];//'ssl';                            // Enable encryption, 'ssl' also accepted
